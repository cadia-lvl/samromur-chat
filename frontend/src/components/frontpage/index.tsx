                ...
                <Layout>
                    <FrontPageContainer>
                        ...
                        <WelcomeTextContainer>
                            ...
                            <p>
                                Þátttaka þín í þessu verkefni felst í því að eiga samtal við annan þátttakenda í 15 til
                            ...
                            <p>
                                Umræðuefnið má vera allt milli himins og jarðar en hafa ber í huga að samtalið og
                                skrifleg útgáfa þess verður opin öllum. Vegna þess biðjum við um að engar
                                persónugreinanlegar upplýsingar verði hluti af samtalinu. Dæmi um slíkar upplýsingar er
                                nafn, kennitala eða heimilisfang þitt og annara. Ef slíkar upplýsingar slæðast með má
                                hafa samband við okkur á netfangið samromur@ru.is og við fjarlægjum þær áður en gögnin
                                verða birt. Stöku slettur úr öðrum tungumálum eru í lagi og það sama á við um lengri
                                þagnir, hikorð og önnur hljóð svo sem ræskingar eða hósta. Það sem skiptir mestu er að
                                talað sé með eðlilegum hætti en þetta er jú allt hluti af eðlilegu talmáli.
                            </p>
