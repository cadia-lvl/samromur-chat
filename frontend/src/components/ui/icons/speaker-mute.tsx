...
export const Speaker: React.FC<IconProps> = (props) => (
    <Icon viewBox="0 0 512 512" className="close" {...props}>
        <g>
            <g>
                <path
                    d="M262.78,57.853c-5.042-2.556-11.091-2.059-15.65,1.284l-116.54,85.462H15c-8.284,0-15,6.716-15,15V352.4
        ...
        <g>
            <g>
                <path
                    d="M445.913,256.002l61.693-61.693c5.858-5.857,5.858-15.355,0-21.213c-5.857-5.857-15.355-5.857-21.213,0L424.7,234.789
