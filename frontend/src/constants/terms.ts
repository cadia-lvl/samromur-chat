export const terms = [
    {"title": 'Skilmálar vegna þátttöku í upptökum á samræðum og fyrirspurnum.',
     "date": 'Skilmálar voru uppfærðir 21.september 2020.',
     "description": [[ 
                    'Á vefsvæðinu ',
                    [{'link': 'https://spjall.samromur.is', 'text': 'www.spjall.samromur.is'}], 
    ...
    "articles" : [{ "heading": 'Þátttaka í gerð gagnasafnsins',
                    "paragraphs": [ 
