export const privacypol = [
    ...
    articles: [
                ...
                paragraphs: ['Öflug persónuvernd er HR kappsmál og leggjum við mikla áherslu á að virða réttindi einstaklinga og að öll meðferð persónuupplýsinga sé ávallt í samræmi við gildandi regluverk á hverjum tíma, sem og í samræmi við bestu venjur á sviði máltækni.'
                    ]
               },
              { heading: 'Hvaða persónuupplýsingum safnar HR um þig og hver er tilgangurinn með söfnuninni?',
                paragraphs: ['HR leggur áherslu á að vinna einungis þær persónuupplýsingar sem nauðsynlegar eru í samræmi við þann tilgang sem liggur að baki söfnun upplýsinganna. HR vinnur persónuupplýsingar ekki frekar í óskyldum tilgangi nema einstaklingi sé tilkynnt um slíkt og þá heimild sem vinnslan byggir á. HR safnar, eins og við á hverju sinni, einkum eftirfarandi persónuupplýsingum: ',
                    '• raddupptökum',
            ...
            { heading: 'Lagalegur grundvöllur fyrir vinnslu',
              paragraphs: ['HR safnar og vinnur persónuupplýsingar byggt á heimild í 6. tl. 1. mgr. 9. gr. persónuverndarlaga, þ.e. vegna lögmætra hagsmuna stofnunarinnar. Eftir atvikum kann HR einnig að vinna persónuupplýsingar byggt á samþykki þínu, sbr. 1. tl.1. mgr. 9. gr. persónuverndarlaga, s.s. ef þú skráir þig á póstlista okkar.',
            ...
            { heading:  'Öryggi persónuupplýsinga og tilkynning um öryggisbrot',
              paragraphs: [ 'Öryggi í vinnslu persónuupplýsinga er HR mikilvægt og höfum við gripið til viðeigandi tæknilegra og skipulagslegra öryggisráðstafana til að tryggja vernd persónuupplýsinga þinna. Þessum ráðstöfunum er ætlað að vernda persónuupplýsingar gegn því að þær glatist eða breytist fyrir slysni og gegn óleyfilegum aðgangi, afritun, notkun eða miðlun þeirra. Komi upp öryggisbrot er varðar þínar persónuupplýsingar munum við bregðast við í samræmi við persónuverndarlög.'
                        ]
            },
            { heading:  'Réttindi þín',
              paragraphs: ['Með fyrirvara um þau skilyrði sem nánar er fjallað um í gildandi löggjöf um persónuvernd, þá átt þú rétt á að: ',
            ...
            [{link: 'https://lvl.ru.is/',
              text: 'Mál- og raddtæknistofu Gervigreindarseturs HR'}],
            '.'],
            ...
            { heading: 'Yfirferð og endurskoðun persónuverndaryfirlýsingar HR',
                paragraphs: [    'Persónuverndaryfirlýsing HR er endurskoðuð reglulega og uppfærð ef tilefni er til. Allar breytingar sem kunna að verða gerðar taka gildi eftir að uppfærð útgáfa hefur verið birt á heimasíðu Samróms.']
            }
        ],
